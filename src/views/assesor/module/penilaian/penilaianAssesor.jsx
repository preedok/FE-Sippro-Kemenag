...
import FormUpdateSarjana from "./sarjana/form-penilaian-sarjana/edit/editPenilaianAssesor";
import FormUpdateMagister from "./magister/form-penilaian-magister/edit/editPenilaianAssesor";
import FormUpdateDoctor from "./doktor/form-penilaian-doctor/edit/editPenilaianAssesor";
import FormUpdateProfesi from './profesi/form-penilaian-profesi/edit/editPenilaianAssesor'
...
const CardPenilaian = () => {
  ...
  const handleViewChange = (index, programStudiId) => {
    ...
    switch (index) {
      case 1:
        navigate("penilaian/sarjana/edit/:id");
        break;
      case 4:
        navigate("penilaian/magister/edit/:id");
        break;
      case 7:
        navigate("penilaian/doktor/edit/:id");
        break;
      case 10:
        navigate("penilaian/profesi/edit/:id");
        break;
      default:
        break;
    }
