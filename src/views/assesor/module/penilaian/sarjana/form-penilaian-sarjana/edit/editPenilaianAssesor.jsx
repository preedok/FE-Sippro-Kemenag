...
import BobotEnumDoctor from '../../../utils/BobotS1'
...
const CardPenilaian = () => {
  ...
  const getData = async () => {
    ...
    try {
      ...
      setAssesmentAcceptedTime(response.data.data.asesorProgramStudis.assesmentAcceptedTime)
  ...
  const [rows1, setRows1] = useState([
    ...
    },
    {
      butir: "3.3.3",
      note: '',
      keterangan: "Rancangan peralatan untuk melaksanakan praktikum/praktik pada 2 (dua) tahun pertama. Peralatan praktikum/praktik sarana utama di lab/tempat praktikum/ bengkel/ studio/ ruang simulasi, rumah sakit, puskesmas/balai kesehatan/ green house/ lahan untuk percobaan, dan sejenisnya",
      nilai: "",
    ...
    },
    {
      butir: "3.4",
      note: '',
      keterangan: "Perencanaan jumlah dan kualifikasi calon tenaga kependidikan:Jumlah minimal calon tenaga kependidikan terdiri atas 2(dua) orang calon tenaga kependidikan untuk setiap program studi dan 1(satu) orang untuk melayani perpustakaan.Kualifikasi calon tenaga kependidikan minimal berijazah D3, berusia maksimum 56 tahun, dan bekerja penuh waktu 37, 5 jam / minggu",
      nilai: "",
  ...
  useEffect(() => {
    ...
    updatedRows1.map((value) => {
      if (value.butir === '3.3.1') value.nilai = calculateAverageTotalNilai(
                      ...
                      <TableBody style={{
                        ...
                        {isSubmitted ? (
                          <TableRow >
                            ...
                            <TableCell></TableCell>
                            <TableCell></TableCell>
                            <TableCell style={{ textAlign: "center", paddingTop: "2rem", color: darkMode ? "white" : "", }}>
                        ...
                        {rows11.map((row, index) => (
                          <TableRow key={index}>
                            ...
                            <TableCell>
                              ...
                              {row.nilai2 &&
                                data?.asesorProgramStudis?.questions?.form2?.[index]?.nilai2 > 4 && (
                                  <p
                                    className="mt-2 text-center"
                                    style={{
                                      color: "red",
                ...
                <div className=" ms-auto">
                  <input
                    ...
                    value={
                      ...
                      (data?.asesorProgramStudis?.questions &&
                        data.asesorProgramStudis.questions.form2 &&
                        data.asesorProgramStudis.questions.form2[8]?.additionalFields2?.ltrk7) ||
                      ''
                    }
