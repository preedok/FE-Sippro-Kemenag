...
import BobotEnumDoctor from '../../../utils/BobotS3';
...
const CardPenilaian = () => {
  ...
  const [isSwasta, setIsSwasta] = useState(null)
  ...
  const [rows1, setRows1] = useState([
    ...
    },
    {
      ...
      note: '',
      keterangan:
        "Rumusan capaian pembelajaran dari program studi yang diusulkan merujuk SN Dikti (Permendikbud No 3 Tahun 2020) dan sesuai level 9 (sembilan) Kerangka Kualifikasi Nasional Indonesia (Perpres Nomor 8 Tahun 2012)",
      nilai: "",
        ...
        <div className="card-body">
          ...
          <div className="row mt-4">
            <div className="container">
              ...
              >
                ...
                {data?.asesorProgramStudis?.needAssessmentAtLocation === 1 && (
                  <Tab
                    label="Form Penilaian Lapangan"
                    value="five"
                    sx={{
                      color: view === "five" ? "#0F56B3" : "#1C1C1C",
                    }}
                  />
                )}
                <Tab
                                      ...
                                      {index === 4 ? (
                                        ...
                                        row.butir === 'C' ? (
                                          ...
                                          >
                                            ...
                                            <option value="Tidak Ada">Tidak ada Informasi</option>
                                          </select>
                                        ) : (
              ...
              <>
                ...
                <div className="d-flex">
                  ...
                  <select onChange={handleChange} className="form-select ms-2" aria-label="Default select example">
                    <option defaultValue >Konfirmasi</option>
                                ...
                                {row.showButton7 && (
                                  <>
                                    <button
                                      ...
                                      className="text-center fw-bold me-2 mt-1"
                                    >
                                      !
                                    </button>
                                    <input
            ...
            <Box sx={style}>
              ...
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                <Alert severity="info">
                  ...
                  lulusan, (b)deskripsi kompetensinya sesuai level 9 (sembilan)
            ...
            <Box sx={style}>
              ...
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                <Alert severity="info">
                  ...
                  setara level 9 (sembilan) KKNI, dan telah memiliki NIDN pada PT
                  pengusul, di antaranya Lektor Kepala, dan 2 orang Guru Besar
                  (Profesor)
                </Alert>
              </Typography>
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
          ...
          >
            <Box sx={style}>
              ...
              <div className="d-flex">
                <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                  Luas total rencana ruang perpustakaan (m2) (gunakan data Butir 3.3.1)
                </Typography>
                <div className=" ms-auto">
                  <input
                    onKeyDown={(e) => {
          ...
          >
            <Box sx={style}>
              ...
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                <Alert severity="info">
                  {" "}
                  1 Ada perpustakaan di luar PT yang dapat diakses dan kurang baik
                  fasilitasnya.
                </Alert>
              </Typography>
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
