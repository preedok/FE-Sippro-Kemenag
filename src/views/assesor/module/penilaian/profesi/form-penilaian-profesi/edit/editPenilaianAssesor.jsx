...
import BobotEnumPPG from '../../../utils/BobotPPG'
...
const CardPenilaian = () => {
  ...
  }, [result, result2, result4, result5, result6, result7, result8, formData9, formData10, formData11]);
      ...
      const formPenilaian = {
        ...
        questions: {
          form2: rows1.map((row) => ({
            ...
            note: row.note,
            additionalFields: {
              terpenuhi: String(formData2.terpenuhi),
              terpenuhikurangsatu: String(formData2.terpenuhikurangsatu),
              terpenuhikurangdua: String(formData2.terpenuhikurangdua),

              doktorlebihdua: String(formData3.doktorlebihdua),
              doktorkurangdua: String(formData3.doktorkurangdua),

              profesor: String(formData4.profesor),
              lektorkepala: String(formData4.lektorkepala),
              lektor: String(formData4.lektor),

              linear: String(formData5.linear),
              tidaklinear: String(formData5.tidaklinear),

              ditugaskan: String(formData6.ditugaskan),
              tidakditugaskan: String(formData6.tidakditugaskan),

              magister: String(formData7.magister),
              dibawahmagister: String(formData7.dibawahmagister),

              sesuai: String(formData8.sesuai),
              tidaksesuai: String(formData8.tidaksesuai),

              jikalengkap: String(formData9.jikalengkap),
              jikakurangsatuataulebih: String(formData9.jikakurangsatuataulebih),

              punyahaki: String(formData10.punyahaki),
              belumhaki: String(formData10.belumhaki),

              rumusan: String(formData11.rumusan),
              mekanisme: String(formData11.mekanisme)
            },
          })),
        },
      ...
      >
        ...
        <div className="card-body">
          ...
          <div className="row mt-3">
                        ...
                        {isSubmitted ? (
                          ...
                          (rows1.map((row, index) => (
                            <TableRow style={{
                              ...
                              <TableCell style={{ color: darkMode ? "white" : "", }} scope="row">{row.keterangan}</TableCell>
                                    ...
                                    <div className="flex-column " style={{ marginTop: '4rem' }}>
                                      ...
                                      <div className="d-flex">
                                        <input
                                          type="text"
                                          className="form-control"
                                          value={isNaN(calculateTotalNilai11(formData11.rumusan, formData11.mekanisme)) ? 0 : calculateTotalNilai11(formData11.rumusan, formData11.mekanisme)}
                                          disabled
                                        />
                                      </div>
                                      ...
                                      {isNaN(calculateTotalNilai11(formData11.rumusan, formData11.mekanisme)) && (
            ...
            <div className="d-flex gap-3 mt-2 ms-auto">
              <Button
                onClick={handleGoBack}
                sx={{
                  border: "1px solid grey",
              ...
              <div className="d-flex">
                ...
                <div className="ms-auto mt-4">
                  <input
                    ...
                    className="form-control"
                    disabled
                    value={calculateTotalNilai2(formData2.terpenuhi, formData2.terpenuhikurangsatu, formData2.terpenuhikurangdua) || 0}
                  />
                </div>
              </div>
              ...
              <div className="d-flex">
                ...
                <div className="ms-auto">
                  <input
                    ...
                    type="text"
                    className="form-control"
                    value={calculateTotalNilai3(formData3.doktorkurangdua, formData3.doktorlebihdua) || 0}
                    disabled
                  />
                </div>
              </div>
              ...
              <div className="d-flex">
                ...
                <div className="ms-auto">
                  <input
                    ...
                    type="text"
                    className="form-control"
                    value={calculateTotalNilai4(formData4.lektor, formData4.lektorkepala, formData4.profesor) || 0}
                    disabled
                  />
                </div>
              </div>
              ...
              <div className="d-flex mt-2">
                ...
                <div className="ms-auto">
                  <input
                    ...
                    type="text"
                    className="form-control"
                    value={calculateTotalNilai5(formData5.linear, formData5.tidaklinear) || 0}
                    disabled
                  />
                </div>
              </div>
              ...
              <div className="d-flex mt-2">
                ...
                <div className="ms-auto">
                  <input
                    ...
                    type="text"
                    className="form-control"
                    value={calculateTotalNilai6(formData6.ditugaskan, formData6.tidakditugaskan) || 0}
                    disabled
                  />
                </div>
              </div>
              ...
              <div className="d-flex mt-2">
                ...
                <div className="ms-auto">
                  <input
                    ...
                    type="text"
                    className="form-control"
                    value={calculateTotalNilai7(formData7.magister, formData7.dibawahmagister) || 0}
                    disabled
                  />
                </div>
              </div>
              ...
              <div className="d-flex mt-2">
                ...
                <div className="ms-auto">
                  <input
                    ...
                    type="text"
                    className="form-control"
                    value={calculateTotalNilai8(formData8.sesuai, formData8.tidaksesuai) || 0}
                    disabled
                  />
                </div>
              </div>
