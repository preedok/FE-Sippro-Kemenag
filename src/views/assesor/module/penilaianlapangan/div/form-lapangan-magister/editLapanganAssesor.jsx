        ...
        try {
            ...
            const defaultQuestions = {
                form: [
                    ...
                    { code: "KDT", question: "Kesiapan Dosen tetap (Khusus D-IV: Kesediaan minimal 2 Guru Besar)", nilai: "", note: "" },
                ...
                kesimpulan: [
                    { code: "TRDS", question: "Diterima/Direkomendasikan dengan syarat", nilai: "", note: "" },
                    { code: "DSMSP", question: "Direkomendasikan setelah melengkapi syarat-syarat pokok", nilai: "", note: "" },
                    { code: "TDKTMSP", question: "Tidak Direkomendasikan karena tidak memenuhi syarat pokok", nilai: "", note: "" },
                        ...
                        <div className="col-12 mt-4 d-flex">
                            ...
                            <div className="d-flex gap-3 ms-auto">
                                ...
                                <Button
                                    ...
                                    variant="contained"
                                    onClick={handlePutRequestDraf}
                                    disabled={data?.asesorALProgramStudis?.status === 223}
                                >
                                ...
                                >
                                    {data?.asesorALProgramStudis?.status === 222 ? 'Submit Penilaian Lapangan' : 'Edit Penilaian '}
                                </Button>
                            </div>
                        </div>
                        {Object.keys(validationErrors).length > 0 && (
                            <Alert severity="error" className="mt-3">
                                Mohon isi semua bidang yang diperlukan sebelum mengirim.
                            </Alert>
                        )}
                    </div>
                </div>
