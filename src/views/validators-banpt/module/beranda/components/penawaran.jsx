...
//             const filteredArray = result.filter(item => item.asesors.some(asesor => asesor.asesorId === +auth.user_id));
//             if (!year) {
...
//         const filteredData = item.asesors.filter((asesor) => asesor.asesorId === +auth.user_id);
...
//                 >
//                     {view === 0 &&
//                         `Data Rekapitulasi Penawaran Penilai Usulan Prodi Tahun ${year}`}
//                     {view == 1 && "Penawaran Penilaian Usulan Prodi Baru"}
//                 </span>
//             </div>
...
//                             }}
//                         >
//                             Konfirmasi Penawaran Penilaian Usulan Prodi Baru
//                         </Typography>
//                         <Box sx={{ padding: 4 }}>
//                             {selectedItem && (
