        ...
        {(function () {
          switch (view) {
            case "beranda":
              return (
                <>
                  <Navigate to="/validator-banpt/beranda" replace />
                  <motion.div
            ...
            case "penawaran":
              return (
                <>
                  <Navigate to="/validator-banpt/penunjukan" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
            ...
            case "penilaian":
              return (
                <>
                  <Navigate to="/validator-banpt/validasi" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "panduan":
              return (
                <>
                  <Navigate to="/validator-banpt/panduan" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "report":
              return (
                <>
                  <Navigate to="/validator-banpt/report" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
