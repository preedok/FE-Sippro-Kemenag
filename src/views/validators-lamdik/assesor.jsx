        ...
        {(function () {
          switch (view) {
            case "beranda":
              return (
                <>
                  <Navigate to="/validator-lamdik/beranda" replace />
                  <motion.div
            ...
            case "penawaran":
              return (
                <>
                  <Navigate to="/validator-lamdik/penunjukan" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
            ...
            case "penilaian":
              return (
                <>
                  <Navigate to="/validator-lamdik/validasi" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "panduan":
              return (
                <>
                  <Navigate to="/validator-lamdik/panduan" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "report":
              return (
                <>
                  <Navigate to="/validator-lamdik/report" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
