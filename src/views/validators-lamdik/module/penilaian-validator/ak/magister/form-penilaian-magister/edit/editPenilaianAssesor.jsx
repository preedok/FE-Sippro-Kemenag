...
import BobotEnumDoctor from '../../../../../../../assesor/module/penilaian/utils/BobotS2'
...
import FormALPenilaianValidatorBanpt from '../../../../al/magister/form-lapangan-magister/editLapanganAssesor'
        ...
        <div className="card-body">
          ...
          <div className="row mt-4" style={{ lineHeight: "5px" }}>
            <div className="col-sm-12 col-md-12 mb-4">
              <p>Evaluator A, Evaluator B dan Evaluator C (PENILAIAN LAPANGAN):</p>
            </div>
          </div>
                      ...
                      <TableBody>
                        {
                          rows1.map((row, index) => (
                            <TableRow style={{
                              ...
                              <TableCell style={{ color: darkMode ? "white" : "", width: '40%' }}>{row.keterangan}</TableCell>
                              <TableCell style={{ color: darkMode ? "white" : "", width: '10px' }} className="text-center">{row.bobot}</TableCell>
