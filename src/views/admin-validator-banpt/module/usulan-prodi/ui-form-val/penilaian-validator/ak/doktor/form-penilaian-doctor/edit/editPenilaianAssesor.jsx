...
const CardPenilaian = () => {
  ...
  const validateForm1 = () => {
    ...
    for (const row of rows11) {
      ...
      if (
        !row.note2 &&
        !(row.nilai2 && row.nilai2.toString() == calculateFinalValue1())
      ) {
        return false;
      }
    }
            ...
            <Box sx={style}>
              ...
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                <Alert severity="info">
                  ...
                  sampai 2 (dua) tahun pembelajaran
                </Alert>
              </Typography>
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                <Alert severity="info">3 Tidak ada skor 3</Alert>
              </Typography>
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                <Alert severity="info">
                  2 Peralatan tersedia dalam jumlah dan mutu yang mencukupi
                  untuk pembelajaran pada 1 (satu) tahun pertama
                </Alert>
              </Typography>
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                <Alert severity="info">
                  1 Peralatan tersedia dalam jumlah yang mencukupi untuk
                  pembelajaran, tetapi tidak sesuai dengan mata kuliah
                  berpraktikum
                </Alert>
              </Typography>
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
