      ...
      >
        <div className="d-flex">
          ...
          >
            ...
            Rekapitulasi Usulan Program Studi Validasi BanPT
          </button>
        </div>
        <ContentCard>
            ...
            {activeTab == 0 ? (
              <>
                ...
                <Grid container spacing={4} className="mt-4">
                  <Grid item xs={12}>
                    <Typography variant="h6" className="mb-3" gutterBottom sx={{ fontWeight: 'bold', color: darkMode ? "white" : "primary.main" }}>Data Rekapitulasi Usulan Program Studi Validasi BanPT</Typography>
                    <StatCardTotal
