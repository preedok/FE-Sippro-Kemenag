        ...
        {(() => {
          switch (view) {
            case "beranda":
              return (
                <>
                  <Navigate to="/admin-validator-banpt/beranda" replace />
                  <motion.div
            ...
            case "usulan-lembaga-lama":
              return (
                <>
                  <Navigate to="/admin-validator-banpt/usulan/lembaga-lama" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "usulan-lembaga-baru":
              return (
                <>
                  <Navigate to="/admin-validator-banpt/usulan/lembaga-baru" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "penawaran":
              return (
                <>
                  <Navigate to="/admin-validator-banpt/penawaran" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "management":
              return (
                <>
                  <Navigate to="/admin-validator-banpt/user" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "report":
              return (
                <>
                  <Navigate to="/admin-validator-banpt/report" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
