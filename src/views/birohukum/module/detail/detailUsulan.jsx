...
import { getToken, isAuth, getToken, getUserId, getRole } from "../../../../utils/token";
      ...
      >
        <ContentContainer>
          ...
          <ContentCard>
                      ...
                      <TableHead>
                        <TableRow style={{
                          ...
                          <TableCell sx={{
                            ...
                            border: "none",
                            color: darkMode ? "white" : "", }}>Kode</TableCell>
                          <TableCell sx={{
                            backgroundColor: darkMode ? "#0C359E" : "#F9FAFC",
                            border: "none",
                            color: darkMode ? "white" : "",
            ...
            {root?.status === 2 && (
              <button style={{ backgroundColor: 'green' }} className="d-flex btn mt-3 btn-primary mb-3 mb-2 me-2 ms-auto"
                onClick={() => {
                  Swal.fire({
                    ...
                    preConfirm: (note) => {
                      if (note) {
                        handleApprove(root?.id, note);
                      } else {
                        handleApprove(root?.id, '');
                      }
                    }
                  });
                }}
              ><CheckCircleOutlineIcon />Konfirmasi kepenilaian</button>
            )}
          </ContentCard>
            ...
            <Box sx={style} style={{ overflow: 'auto' }}>
              ...
              <Typography style={{ color: darkMode ? "white" : "" }} id="modal-modal-title" variant="h6" component="h2" className="mb-2 ms-3 fw-bold">
                ...
                <div className="p-4 d-flex flex-column flex-md-row">
                  <PdfViewerModal />
                <div style={{ color: darkMode ? "white" : "" }} className="ms-auto">
