    ...
    <>
      ...
      >
        ...
        <div className="d-flex">
          <button
            className={`btn  border-0  ms-4 me-2`}
            onClick={() => handleViewChange("user")}
            style={{
              backgroundColor: view === "user"
          ...
          >
            <span role="img" aria-label="Daftar User PTKI" style={{ marginRight: "5px", fontSize: "23px" }}>👥</span>
            Daftar User PTKI
            {loading && view === "user" && <ClipLoader size={18} className="ms-1 mt-2" />}
          </button>
          <button
            className={`btn  border-0`}
            onClick={() => handleViewChange("asesor")}
            style={{
              backgroundColor: view === "asesor"
                ? (darkMode ? "#3C5B6F" : "white")
                : (darkMode ? "transparent" : ""),
              color: view === "asesor"
                ? (darkMode ? "white" : "black")
          ...
          >
            <span role="img" aria-label="Daftar Evaluator" style={{ marginRight: "5px", fontSize: "22px" }}>🧑‍🏫</span>
            Daftar Evaluator
            {loading && view === "asesor" && <ClipLoader size={18} className="ms-1 mt-2" />}
          </button>
          <button
            className={`btn  border-0`}
            onClick={() => handleViewChange("admin")}
            style={{
              backgroundColor: view === "admin"
                ? (darkMode ? "#3C5B6F" : "white")
                : (darkMode ? "transparent" : ""),
              color: view === "admin"
                ? (darkMode ? "white" : "black")
          ...
          >
            <span role="img" aria-label="Daftar Administrator" style={{ marginRight: "5px", fontSize: "22px" }}>👨‍💼</span>
            Daftar Administrator
            {loading && view === "admin" && <ClipLoader size={18} className="ms-1 mt-2" />}
          </button>
          <button
            className={`btn  border-0`}
          ...
          <Box sx={style1}>
            ...
            <Typography id="modal-modal-description" sx={{ mt: 2 }}>
              <div className="d-flex gap-2">
                <h4 className={`${style.judul} fw-bold`}>
              ...
              {view1 === 0 && (
                <>
                  <div className="position-relative">
                    ...
                    <div className="d-flex">
                      <div className="col-2">
                        <label className="form-label">NIP / NPWP </label>
                      </div>
                      <div className="mb-3 col-5 pe-3">
                        <input
                          type="text"
                    ...
                    <div className="d-flex">
                      <div className="col-2">
                        <label className="form-label">NIRA</label>
                      </div>
                        ...
                        <div className="d-flex">
                          <div className="form-check">
                            <input
                              ...
                              name="gender"
                            />
                            <label className="form-check-label ms-2 me-4">
                              Laki-Laki
                            </label>
                          </div>
                          <div className="form-check">
              ...
              {view1 === 2 && (
                <>
                  ...
                  <div className="d-flex">
                    <div className="col-2">
                      <label className="form-label">No Telp & HP</label>
                    </div>
                    <div className="mb-3 col-5 pe-3">
                      <input
                        type="text"
                  ...
                  <div className="mt-3">
                    ...
                    <div className="mb-3 col-12">
                      ...
                      <input
                        ...
                        id="password"
                        name="password"
                        className={`${style.input2} form-control w-100 ${formik.touched.password && formik.errors.password
                          ? "is-invalid"
                          : ""
                          }`}
                    ...
                    <div className="mb-3 col-12">
                      ...
                      <input
                        ...
                        className={`${style.input2} form-control w-100 ${formik.touched.passwordConfirm &&
            ...
            <div>
              ...
              <div className="d-flex gap-4">
                <TextField
                  ...
                  id="password"
                  name="password"
                  style={{ height: "54px", background: darkMode ? "white" : "" }}
              ...
              <div className="d-flex gap-4 mt-2">
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    style={{ background: darkMode ? "white" : "" }}
                  >
                    <MenuItem selected sx={{ fontStyle: 'italic' }} disabled>Pilih Role</MenuItem>
                    <MenuItem value={0}>DirekturJendral</MenuItem>
                    <MenuItem value={1}> Direktur PTKI</MenuItem>
                    {/* <MenuItem value={2}>AsesorInstitusi</MenuItem> */}
                    <MenuItem value={4}>Kasubdit</MenuItem>
                    <MenuItem value={5}>Subdit</MenuItem>
                    {/* <MenuItem value={6}>Kopertais</MenuItem> */}
                    <MenuItem value={7}>BANPT</MenuItem>
                    <MenuItem value={9}>LAMDIK</MenuItem>
                    <MenuItem value={10}>LAMEMBA</MenuItem>
                    <MenuItem value={8}>Biro Hukum dan Kerja Sama Luar Negeri</MenuItem>
                    <MenuItem value={11}>Verfikator (PTSP)</MenuItem>
                    <MenuItem value={52}>Bendahara</MenuItem>
                  </Select>
                </FormControl>
              </div>
            </div>
