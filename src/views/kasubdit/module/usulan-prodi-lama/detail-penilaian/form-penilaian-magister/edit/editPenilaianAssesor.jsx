...
import BobotEnumDoctor from '../../../../../../../views/assesor/module/penilaian/utils/BobotS2'
...
const CardPenilaian = () => {
  ...
  const handleDownloadFilePenilaian = async () => {
    try {
      const programStudiId = localStorage.getItem('programStudiId')
      const asesorId = localStorage.getItem('testAsesorId')
                              ...
                              <div className="d-flex">
                                ...
                                {row.showButton7 && (
                                  <>
                                    ...
                                    <div>
                                      <input
                                        value={rows1[index].nilai || calculateFinalValue()}
                                        className="form-control"
                                        type="text"
                                        disabled
                                      />
                                  ...
                                  <div>
                                    ...
                                    <div className="d-flex">
                                      ...
                                      <input
                                        ...
                                        className="form-control mt-2"
                                        value={calculateTotalNilai5(formData9.ltrp)}
                                        disabled
                                      />
                                    </div>
              ...
              <div className=" mt-3">
                ...
                >
                  ...
                  <div className="col-12 d-flex">
                    ...
                    <div className="col-12 d-flex">
                      <p className="ms-4">Rekomendasi</p>
                      <p
                        style={{ borderRadius: "10px" }}
                        className="px-2  fw-bold py-2 bg-success ms-auto text-white"
                      >
                ...
                <input
                  ...
                  value={
                    ...
                    (data?.asesorProgramStudis?.questions &&
                      data.asesorProgramStudis.questions.form2 &&
                      data.asesorProgramStudis.questions.form2[2]?.additionalFields?.Na) ||
                    ''
                  }
              ...
              <div className=" ms-auto">
                <input
                  ...
                  value={
                    ...
                    (data?.asesorProgramStudis?.questions &&
                      data.asesorProgramStudis.questions.form2 &&
                      data.asesorProgramStudis.questions.form2[2]?.additionalFields?.Nb) ||
                    ''
                  }
              ...
              <div className=" ms-auto">
                <input
                  ...
                  value={
                    ...
                    (data?.asesorProgramStudis?.questions &&
                      data.asesorProgramStudis.questions.form2 &&
                      data.asesorProgramStudis.questions.form2[2]?.additionalFields?.Nc) ||
                    ''
                  }
              ...
              <div className=" ms-auto">
                <input
                  ...
                  value={
                    ...
                    (data?.asesorProgramStudis?.questions &&
                      data.asesorProgramStudis.questions.form2 &&
                      data.asesorProgramStudis.questions.form2[2]?.additionalFields?.f) ||
                    ''
                  }
