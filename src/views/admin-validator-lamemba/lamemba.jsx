        ...
        {(() => {
          switch (view) {
            case "beranda":
              return (
                <>
                  <Navigate to="/admin-validator-lamemba/beranda" replace />
                  <motion.div
            ...
            case "usulan-lembaga-lama":
              return (
                <>
                  <Navigate to="/admin-validator-lamemba/usulan/lembaga-lama" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "usulan-lembaga-baru":
              return (
                <>
                  <Navigate to="/admin-validator-lamemba/usulan/lembaga-baru" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "penawaran":
              return (
                <>
                  <Navigate to="/admin-validator-lamemba/penawaran" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "management":
              return (
                <>
                  <Navigate to="/admin-validator-lamemba/user" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
            ...
            case "report":
              return (
                <>
                  <Navigate to="/admin-validator-lamemba/report" replace />
                  <motion.div
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
