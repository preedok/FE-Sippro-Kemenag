...
//             } else if (key === 'gender' || key === 'pangkat' || key === 'lastEducation') {
//               // Convert to number
...
//         const response = await api.post("/auth/register-asesor-wfile", formData, {
//           headers: {
...
//             formik.handleSubmit();
//           } else {
//             // If there are errors, set all fields as touched to display error messages
//             formik.setTouched(
//               Object.keys(formik.values).reduce((touched, key) => {
//                 touched[key] = true;
//                 return touched;
...
//                   <label className="form-label me-3" style={{ color: darkMode ? "white" : "" }}>
//                     Upload Surat Tugas
//                   </label>

//                   <button
//                     type="button"
//                     className={`btn btn-success ms-5 w-30 ${formik.touched.file && formik.errors.file ? "is-invalid" : ""}`}
...
//                     id="file"
//                     name="file"
//                     className="d-none" // Disembunyikan
//                     onChange={handleFileChange}
//                     aria-describedby="fileError"
//                   />

//                   {file && (
//                     <p className="mt-2 ms-5" style={{ color: darkMode ? "white" : "" }}>
//                       {file.name}
//                     </p>
//                   )}

//                   {formik.touched.file && formik.errors.file && (
//                     <div id="fileError" className="invalid-feedback d-block">
//                       {formik.errors.file}
//                     </div>
//                   )}
//                 </div>
...
//                 <div className="d-flex">
//                   <div className="col-2">
//                     <label className="form-label" style={{ color: darkMode ? "white" : "" }}>No Telp & HP</label>
//                   </div>
//                   <div className="mb-3 col-5 pe-3">
//                     <input
//                       type="text"
